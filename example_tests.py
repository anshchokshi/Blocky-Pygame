...
class TestPlayer:
    ...
    def test_get_block_top_left(self, board_16x16) -> None:
        ...
        """
        top_left = (0, 377)
        assert _get_block(board_16x16, top_left, 1) == board_16x16.children[2]
...
class TestGoal:
    ...
    def test_block_flatten(self, board_16x16, flattened_board_16x16) -> None:
        ...
        of colours.
        """
        #x = _flatten(board_16x16.children[0])
    ...
    def test_blob_goal(self, board_16x16_) -> None:
        correct_scores = [
            (COLOUR_LIST[0], 4),
            (COLOUR_LIST[1], 16),
            (COLOUR_LIST[2], 16),
        ...
        for colour, expected in correct_scores:
            ...
            assert goal.score(board_16x16_) == expected
